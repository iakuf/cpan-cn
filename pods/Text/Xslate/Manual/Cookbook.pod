...
Text::Xslate::Manual::Cookbook - 如何更好的使用 Xslate 模板 

=head1 概述

这个 Xslate 的 cookbook 是用来展示 Xslate 相关特性和功能的指南.

=head1 食谱

=head2 如何管理 HTML forms
...
=head2 在 Kolon 语法中怎么样使用 Template Toolkit's 的 WRAPPER 类似的功能

使用模板级联, 这是一个 super-set 的 C<WRAPPER> 指令
